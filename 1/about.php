...
<html>
 <head>
    <meta charset="utf-8">
    <title>Sistem Akademik UAD</title>
	<!-- Library CSS -->
	<?php
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>Akademik UAD</b></center></h1>
					<center><img src="../aset/foto/logo.png" width="225" height="225" /></center>
					<center><h2><b>Sistem Akademik UAD Developer Copyright &copy;  <?php echo date ('Y') ?></b></h2></center>
					<center><h4><b>Made with <i class="fa fa-heart"></i> by ALBAL (Alif & Iqbal) in Kost Alif, Yogyakarta, Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
