            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<h1><center><b>Sistem Akademik UAD</b></center></h1>
					...
					<center><h4><b>Made with <i class="fa fa-heart"></i> by ALBAL (Iqbal & Alif), In Kost Alif, Yogyakarta, Indonesia</b></h4></center>
                </div><!-- /.box-header -->
                <div class="box-body">
